...
namespace L02P02_2021DP650_2021CR650.Controllers
{
    public class LibreriaDbController : Controller
    {
        private readonly libreriaDbContext _libreriaDbContext;
        public LibreriaDbController(libreriaDbContext libreriaDbContext)
        {
